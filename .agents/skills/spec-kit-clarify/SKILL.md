...
5. Sequential questioning loop (interactive):
    ...
    - **Question writing quality (applies to every question, MC or short-answer):**
       ...
       - NEVER use a topic label, section heading, or requirement id as the question itself. For example, `Acceptance device/runtime matrix (FR-023)` is INVALID â€” it is a label, not a question.
